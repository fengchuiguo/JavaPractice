package com.EncryptDecrypt.T2.hmac;
...
public class TestHmac {
    ...
    private static String src = "test security hmac";
...
//			byte[] key = secretKey.getEncoded();//获得密钥
            byte[] key = Hex.decodeHex(new char[]{'a', 'b', 'c', 'd', 'e', 'f'});
    ...
    public static void bcHmacMD5() {
        ...
        hmac.init(new KeyParameter(org.bouncycastle.util.encoders.Hex.decode("abcdef")));
